...
./calculate_suspended_par10.py data/8_full_model_noworryback_streamliner.csv $timeout $3 | tr -d '\n'
echo -n ','
./calculate_suspended_fraction_certain.py data/8_full_model_noworryback_streamliner.csv $timeout $3 | tr -d '\n'
echo -n ','
...
./calculate_suspended_par10.py data/4_unblocked_relaxed_stock.csv,data/8_full_model_noworryback_streamliner.csv,data/1_solvitaire_no_streamliner.csv $timeout $3 | tr -d '\n'
echo -n ','
./calculate_suspended_fraction_certain.py data/4_unblocked_relaxed_stock.csv,data/8_full_model_noworryback_streamliner.csv,data/1_solvitaire_no_streamliner.csv $timeout $3 | tr -d '\n'
echo -n ','

./calculate_suspended_par10.py data/3_unblocked_full_stock.csv,data/8_full_model_noworryback_streamliner.csv,data/1_solvitaire_no_streamliner.csv $timeout $3 | tr -d '\n'
echo -n ','
./calculate_suspended_fraction_certain.py data/3_unblocked_full_stock.csv,data/8_full_model_noworryback_streamliner.csv,data/1_solvitaire_no_streamliner.csv $timeout $3 | tr -d '\n'
echo -n ','
